document.addEventListener("DOMContentLoaded", function() {
  ...
  /* =========================
     EDIT CUSTOMER
  ========================= */
  window.editCustomer = function(index) { // giữ toàn cục để onclick table vẫn dùng
    ...
    document.getElementById("city-text").value = c.city;
  ...
  /* =========================
     DELETE CUSTOMER
  ========================= */
  window.deleteCustomer = function(index) { // giữ toàn cục để onclick table vẫn dùng
    ...
    fetch(`https://zipcloud.ibsnet.co.jp/api/search?zipcode=${zip}`)
      ...
      .then(data => {
        if(data.results) {
          ...
          document.getElementById("city-text").value = r.address2 + r.address3;
        } else {
